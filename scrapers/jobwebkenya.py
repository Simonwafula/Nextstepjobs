...
class JobScraper:
    def __init__(self, base_url: str = "https://www.jobwebkenya.com"):
    ...
    def parse_job_content(self, html: str) -> str:
        ...
        try:
            ...
            job_content = soup.find('div', class_='section single')
    ...
    def scrape(self, start_page: int = 1, end_page: int = 357, 
...
if __name__ == '__main__':
    ...
    try:
        scraper = JobScraper()
        scraper.scrape(start_page=1, end_page=357, max_workers=10)
